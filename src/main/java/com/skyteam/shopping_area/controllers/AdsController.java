...
import com.skyteam.shopping_area.services.CommentService;
...
public class AdsController {
    ...
    public ResponseEntity<ResponseWrapperCommentDto> getComments(@PathVariable String ad_pk) {
        log.info("Get comments ads id: {}", ad_pk);
        return ResponseEntity.ok().body(commentService.getComments(ad_pk));
    }
    ...
    public ResponseEntity<CommentDto> addComment(@PathVariable String ad_pk, @RequestBody CommentDto commentDto) {
        log.info("Add comments ads id: {}", ad_pk);
        return ResponseEntity.ok(commentService.addComment(ad_pk, commentDto));
    }
    ...
    public ResponseEntity<?> deleteComment(@PathVariable String ad_pk, @PathVariable int id) {
        log.info("Delete comment: {}", ad_pk);
        if (commentService.deleteComments(ad_pk, id)) {
    ...
    public ResponseEntity<CommentDto> updateComment(@PathVariable String ad_pk, @PathVariable int id,
                                                    @RequestBody CommentDto commentDto) {
        log.info("Update comment: {}", ad_pk);
        return ResponseEntity.ok(commentService.updateComments(ad_pk, id, commentDto));
    }
}
